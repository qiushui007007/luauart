...
V1.1: 2014-10-28, 经过深入的科学发展观而形成.
	支持3个设备: CH340+STC+DHT22, CP2102+sharp2, DS9490+DS18B20,
		...
		if portnum >= 0 then
			...
			if len_ret == 9 then
				...
				if crc16 == 0x00 then
					...
					print("valid: h1 = " .. tostring(f_h1) .. ", t1 = " .. tostring(f_t1) )
				end
			end
		end
...
if ds18b20_valid == 1 then
	...
	if f_diff < -f_mark or f_diff > f_mark then
		...
		print(content)
		subject = "18b20 diff bigger than mark"
		mail_tx(to_id, subject, content)
	end
